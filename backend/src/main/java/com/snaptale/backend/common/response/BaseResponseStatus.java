...
public enum BaseResponseStatus {
    ...
    INVALID_MATCH_TYPE(HttpStatus.BAD_REQUEST, "INVALID_MATCH_TYPE"),
    // 게임 로직 오류
    ...
    ALREADY_IN_MATCH(HttpStatus.BAD_REQUEST, "ALREADY_IN_MATCH"),
    INVALID_LOCATION_FOR_TURN(HttpStatus.BAD_REQUEST, "해당 턴에는 이 지역에 카드를 낼 수 없습니다."),
